...
const getPoliticalEntities = async ( nEntities) => {
    const entitiesToAvoid = ['us', 'u.s', 'u.s.', 'united States', 'united', 'states', 'republican', 'liberal'];
    const opts = {
        language: ['en'],
        sort_by: 'recency',
...
module.exports = {
    getPoliticalEntities: getPoliticalEntities
};
